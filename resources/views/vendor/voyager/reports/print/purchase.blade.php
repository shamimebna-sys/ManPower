    ...
    @if($data)
        <table style="width: 100%; padding-top: 20px">
            ...
            <tr style="border: 1px solid #ddd">
                ...
                <th style="padding: 5px;border: 1px solid #ddd; width: 20%">Supplier</th>
            ...
            @endphp
                @foreach($data as $s=>$i)
                    <tr style="border: 1px solid #ddd">
                        ...
                        <td style="padding: 5px;border: 1px solid #ddd;">{{date('d-m-Y', strtotime($i->purchase_date))}}</td>
                        <td style="padding: 5px;border: 1px solid #ddd;">{{$i->supplier->name}}</td>
