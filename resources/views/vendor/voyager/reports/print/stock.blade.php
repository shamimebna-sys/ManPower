    ...
    @if($data)
        <table style="width: 100%; padding-top: 20px">
            ...
            <tr style="border: 1px solid #ddd">
                ...
                <th style="padding: 5px;border: 1px solid #ddd; width: 15%">Code</th>
                <th style="padding: 5px;border: 1px solid #ddd; width: 8%">Name</th>
                <th style="padding: 5px;border: 1px solid #ddd; width: 15%">Variant</th>
            ...
            <tbody>
                @foreach($data as $s=>$i)
                    <tr style="border: 1px solid #ddd">
                        ...
                        <td style="padding: 5px;border: 1px solid #ddd;">{{$i->sku}}</td>
                        <td style="padding: 5px;border: 1px solid #ddd;">{{$i->product->name}}</td>
                        <td style="padding: 5px;border: 1px solid #ddd;">{{$i->variant_display}}</td>
                        <td style="padding: 5px;border: 1px solid #ddd;">{{$i->product->unit->name}}</td>
