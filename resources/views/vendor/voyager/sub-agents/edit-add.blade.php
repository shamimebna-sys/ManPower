...
{{--                                    @include('vendor.voyager.partials.form-field', ['formField'=>'include', 'fields'=>['code'], 'width'=>'4'])--}}
                ...
                <div class="col-md-3">
                    <div class="panel panel-bordered panel-warning">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                @if(in_array(\App\Helpers\CommonClass::user()->role_id,[1,2,106]))
                                    @include('vendor.voyager.partials.form-field', ['formField'=>'include', 'fields'=>['sub_agent_belongsto_agent_relationship'], 'width'=>'12'])
                                @else
                                    <input readonly type="hidden" class="form-control" name="agent_id" placeholder="agent_id" value="{{($edit)?$dataTypeContent->agent_id:\App\Helpers\CommonClass::user()->profile_id}}">
                                @endif
                                ...
                                @include('vendor.voyager.partials.form-field', ['formField'=>'include', 'fields'=>['balance'], 'width'=>'12'])
                            </div>
