...
class SelectedCandidateSummary extends BaseDimmer
{
    ...
    public function run()
    {
        ...
        $table['table_data'] = (array) \DB::select(" SELECT  c.name, sc.position, DATE(sc.created_at) AS created_date
    ...
    public function shouldBeDisplayed()
    {
        /*
           ...
           108	 	Agency
       */
        if( in_array(\auth()->user()->role_id, [1, 2, 100, 101,  103, 104, 105, 106, 107, 108])){
            return true;
        }else{
            return false;
        }
