...
class UpcomingInterviewSchedule extends BaseDimmer
{

    public function run()
    {
        $table = [
            'table_title' => 'UPCOMMING INTERVIEW SCHEDULE',
            'table_th' => ['TEACHER NAME','GROUP NAME',  'DAY', 'SCHEDULE'],
            'table_data' => [
...
WHERE s.subject = 'Interview'
  AND s.week_day <> DAYNAME(CURDATE())
