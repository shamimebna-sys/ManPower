...
class VoyagerCandidatesController extends VoyagerBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            $query = $model::select($dataType->name.'.*')->with(['agency', 'company']);
    ...
    public function store(Request $request)
    {
        ...
        if($user && !empty($password) && !empty($request->email)){
            ...
            $notification->user_id = User::where('agent_id', $request->get('agent_id'))->pluck('id')->first();
            $notification->title = 'New candidate has been added on you';
            $notification->message = 'Name: '.$data->name.' Candidate Code: '.$data->code;
            $notification->group_id = $request->get('class_group_id');
            $notification->save();
    ...
    public function update(Request $request, $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'email' => 'required|email|unique:users,email,' . User::where('candidate_id', $id)->pluck('id')->first(),
            'class_group_id' => 'required',
            'agent_id' => 'required',
        ],[
                'class_group_id.required'=>'Group is required',
