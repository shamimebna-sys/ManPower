...
{{\App\Helpers\CommonClass::sendEmail('subject', 'mahedi2014@gmail.com')}}


<!-- Mirrored from htmldemo.net/jetapo/jetapo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Apr 2025 16:35:47 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Jetapo - Job Board Bootstrap 5 Template</title>
                    ...
                    <div class="col-xl-7 col-lg-7 col-12">
                        <nav class="main-menu">
                            <ul>
                                ...
                                <li><a href="#"><span class="label-status hot">hot</span>Jobs</a> </li>
                                <li><a href="#">Employers</a></li>
                                <li><a href="#">  Blog</a> </li>
                                <li><a href="#">Contact</a>   </li>
                                <li><a href="#">FAQS</a>   </li>
                                <li><a href="#"><span class="label-status new">new</span> Admission <small class="icon-arrow"></small></a>
                                <ul class="sub-menu">
                                    <li><a href="#">Be A Candidate</a></li>
                                    <li><a href="#">Be A Teacher</a></li>
                                    <li><a href="#">Be A Agent</a></li>
                                    <li><a href="#">Be A Employeers</a></li>
                                </ul>
                                </li>
    ...
    <div class="popup-mobile-manu popup-mobile-visiable">
        <div class="inner">
            <div class="mobileheader">
                <div class="logo">
                    <a href="#">
                        <img src="assets/images/logo-new.png" alt="Multipurpose">
                    </a>
                </div>
            ...
            <div class="menu-content">
                <ul class="menulist object-custom-menu">
                    ...
                    <li class="has-mega-menu"><a href="#"><span>Candidates</span></a>
                        <!-- Start Dropdown Menu -->
                        <ul class="object-submenu">
                            <li><a href="#"><span>Candidates Listing</span></a></li>
    ...
    <div class="bottom-navbar-mobile section d-block d-lg-none">
        <nav>
            <ul class="list-actions">
                <li>
                    <a class="toggle-btn active" href="#">
    ...
    <div class="mobile-popup">
        <div class="job-list-mobile" id="job-list-mobile-id">
            ...
            <div class="content-popup-scroll">
                <ul class="list-item">
                    <li><a href="#"><i class="lnr lnr-printer"></i>Accounting </a></li>
                    <li><a href="#"><i class="lnr lnr-film-play"></i>Broadcasting </a></li>
                    <li><a href="#"><i class="lnr lnr-phone"></i>Customer Service </a></li>
                    <li><a href="#"><i class="lnr lnr-bullhorn"></i>Digital Marketing </a></li>
                    <li><a href="#"><i class="lnr lnr-chart-bars"></i>Finance & Accounting </a></li>
                    <li><a href="#"><i class="lnr lnr-smartphone"></i>Game Mobile </a></li>
                    <li><a href="#"><i class="lnr lnr-picture"></i>Graphics & Design </a></li>
                    <li><a href="#"><i class="lnr lnr-home"></i>Graphics & Design </a></li>
                    <li><a href="#"><i class="lnr lnr-database"></i>Medical Doctor </a></li>
                    <li><a href="#"><i class="lnr lnr-dinner"></i>Restaurant </a></li>
                </ul>
            </div>
        </div>
