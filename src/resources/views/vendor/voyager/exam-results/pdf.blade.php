        ...
        <table style="width: 100%; padding-top: 20px; border-collapse: collapse;">
            <thead>
                <tr style="border: 1px solid #ddd; background-color: #f5f5f5;">
                    ...
                    <th style="padding: 6px; border: 1px solid #ddd; width: 25%;">Candidate</th>
                    <th style="padding: 6px; border: 1px solid #ddd; width: 20%;">Group</th>
                    ...
                    <th style="padding: 6px; border: 1px solid #ddd; text-align: center; width: 8%;">BL</th>
                    <th style="padding: 6px; border: 1px solid #ddd; text-align: center; width: 8%;">Skill</th>
                    <th style="padding: 6px; border: 1px solid #ddd; text-align: center; width: 8%;">English</th>
                    <th style="padding: 6px; border: 1px solid #ddd; text-align: center; width: 10%;">Result</th>
                </tr>
            </thead>
            <tbody>
                @foreach($data as $index => $item)
                    <tr style="border: 1px solid #ddd;">
                        ...
                        <td style="padding: 6px; border: 1px solid #ddd;">
                            {{ optional(optional($item->candidate)->classGroup)->group_info ?? 'N/A' }}
                        </td>
