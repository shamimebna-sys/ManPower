    ...
    @if($data && count($data) > 0)
        <table style="width: 100%; padding-top: 20px; border-collapse: collapse;">
            ...
            <tr style="border: 1px solid #ddd; background-color: #f5f5f5;">
                ...
                <th style="padding: 6px; border: 1px solid #ddd; width: 35%;">CANDIDATE NAME & CODE</th>
                <th style="padding: 6px; border: 1px solid #ddd; width: 20%;">PASSPORT NO</th>
                <th style="padding: 6px; border: 1px solid #ddd; text-align: center; width: 15%;">ISSUE DATE</th>
                <th style="padding: 6px; border: 1px solid #ddd; text-align: center; width: 15%;">EXPIRE DATE</th>
                <th style="padding: 6px; border: 1px solid #ddd; text-align: center; width: 10%;">STATUS</th>
            </tr>
            </thead>
            <tbody>
            @foreach($data as $s => $i)
