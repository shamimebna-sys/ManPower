    ...
    @if($data && count($data) > 0)
        <table style="width: 100%; padding-top: 20px; border-collapse: collapse;">
            ...
            <tr style="border: 1px solid #ddd; background-color: #f5f5f5;">
                ...
                <th style="padding: 6px; border: 1px solid #ddd; width: 15%;">ARC NUMBER</th>
                ...
                <th style="padding: 6px; border: 1px solid #ddd; text-align: center; width: 6%;">LIFETIME</th>
