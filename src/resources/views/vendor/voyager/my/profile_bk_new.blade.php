                            ...
                            <form id="cvForm" action="{{ route('admin.my.profile.update') }}" method="POST"
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                @include('vendor.voyager.partials.form-field', ['formField'=>'include', 'fields'=>['position1'], 'width'=>'6', 'required'=>true])
                                                {{--                                                @include('vendor.voyager.partials.form-field', ['formField'=>'include', 'fields'=>['position'], 'width'=>'6'])--}}
                                ...
                                <div class="form-step" data-step="3">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div id="academic-qualification"></div>
                                            <button type="button" class="btn btn-block btn-warning mb-3"
                                                    onclick="addAcademic()">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <table style="width: 100%">
                                                    <tr>
                                                        <td colspan="2" style="width: 100%"> @include('vendor.voyager.partials.form-field', ['formField'=>'include', 'fields'=>['nid_file_path'], 'width'=>'12'])</td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2" style="width: 100%"> @include('vendor.voyager.partials.form-field', ['formField'=>'include', 'fields'=>['passport_file_path'], 'width'=>'12'])</td>
                                                    </tr>
                                                    <tr>
        ...
        function addSkill() {
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Certificate Photo</label>
                        <input type="image" class="form-control" name="skill_certificate_file_path[]">
                    </div>
                </div>
                <div class="row">
