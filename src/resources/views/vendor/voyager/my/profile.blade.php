                                ...
                                <div class="form-step active" data-step="1">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                @include('vendor.voyager.partials.form-field', ['formField'=>'include', 'fields'=>['passport_no'], 'width'=>'6'])
                                                ...
                                                @include('vendor.voyager.partials.form-field', ['formField'=>'include', 'fields'=>['mobile'], 'width'=>'6','required'=>true])
                                            </div>
                                            <div class="row">
                                                @include('vendor.voyager.partials.form-field', ['formField'=>'include', 'fields'=>['abroad_ex'], 'width'=>'3'])
                                                @include('vendor.voyager.partials.form-field', ['formField'=>'include', 'fields'=>['local_ex'], 'width'=>'3'])
                                                @include('vendor.voyager.partials.form-field', ['formField'=>'include', 'fields'=>['height'], 'width'=>'3'])
                                                @include('vendor.voyager.partials.form-field', ['formField'=>'include', 'fields'=>['weight'], 'width'=>'3'])
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="table-responsive">
                                                        <table id="languageTable" class="table table-bordered align-middle">
                                                            ...
                                                            @if(count($languageList)> 0)
                                                                @php
                                                                    $languages =  [
                "Afrikaans","Aghem","Akan","Amharic","Arabic","Assamese","Asu","Asturian",
                "Azerbaijani","Basaa","Belarusian","Bemba","Bena","Bulgarian","Bambara",
                "Bangla","Tibetan","Breton","Bodo","Bosnian","Catalan","Chakma","Chechen",
                "Cebuano","Chiga","Cherokee","Central Kurdish","Czech","Welsh","Danish",
                "Taita","German","Zarma","Dogri","Lower Sorbian","Duala","Jola-Fonyi",
                "Dzongkha","Embu","Ewe","Greek","English","Esperanto","Spanish","Estonian",
                "Basque","Ewondo","Persian","Fulah","Finnish","Filipino","Faroese","French",
                "Friulian","Western Frisian","Irish","Scottish Gaelic","Galician","Swiss German",
                "Gujarati","Gusii","Manx","Hausa","Hawaiian","Hebrew","Hindi","Croatian",
                "Upper Sorbian","Hungarian","Armenian","Interlingua","Indonesian","Igbo",
                "Sichuan Yi","Icelandic","Italian","Japanese","Ngomba","Machame","Javanese",
                "Georgian","Kabyle","Kamba","Makonde","Kabuverdianu","Koyra Chiini","Kikuyu",
                "Kazakh","Kako","Kalaallisut","Kalenjin","Khmer","Kannada","Korean","Konkani",
                "Kashmiri","Shambala","Bafia","Colognian","Kurdish","Cornish","Kyrgyz","Langi",
                "Luxembourgish","Ganda","Lakota","Lingala","Lao","Northern Luri","Lithuanian",
                "Luba-Katanga","Luo","Luyia","Latvian","Maithili","Masai","Meru","Morisyen",
                "Malagasy","Makhuwa-Meetto","Metaʼ","Māori","Macedonian","Malayalam","Mongolian",
                "Manipuri","Marathi","Malay","Maltese","Mundang","Burmese","Mazanderani","Nama",
                "Norwegian Bokmål","North Ndebele","Nepali","Dutch","Kwasio","Norwegian Nynorsk",
                "Ngiemboon","Norwegian","Nuer","Nyankole","Oromo","Odia","Ossetic","Punjabi",
                "Nigerian Pidgin","Polish","Pashto","Portuguese","Quechua","Romansh","Rundi",
                "Romanian","Rombo","Russian","Kinyarwanda","Rwa","Sanskrit","Sakha","Samburu",
                "Santali","Sangu","Sardinian","Sindhi","Northern Sami","Sena","Koyraboro Senni",
                "Sango","Tachelhit","Sinhala","Slovak","Slovenian","Inari Sami","Shona","Somali",
                "Albanian","Serbian","Sundanese","Swedish","Swahili","Tamil","Telugu","Teso",
                "Tajik","Thai","Tigrinya","Turkmen","Tongan","Turkish","Tatar","Tasawaq",
                "Central Atlas Tamazight","Uyghur","Ukrainian","Urdu","Uzbek","Vai","Vietnamese",
                "Vunjo","Walser","Wolof","Xhosa","Soga","Yangben","Yiddish","Yoruba","Cantonese",
                "Standard Moroccan Tamazight","Chinese","Zulu"
            ];
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <select class="form-control" name="language_name[]">
                                                                                @foreach($languages as $v)
                                                                                    @if(($v == $i->language_name))
                                                                                    <option selected value="{{$i->language_name}}">{{$v}}</option>
                                                                                    @else
                                                                        ...
                                                                        <td>
                                                                            <select class="form-control" name="language_status[]">
                                                                                <option {{($i->language_status == 'Very Good')?'selected':''}} value="Very Good">Very Good</option>
                                                                                <option {{($i->language_status == 'Good')?'selected':''}} value="Good">Good</option>
                                                                                <option {{($i->language_status == 'Only For Speaking')?'selected':''}} value="Only For Speaking">Only For Speaking</option>
                                                                                <option {{($i->language_status == 'Little')?'selected':''}} value="Little">Little</option>
                                                                                <option {{($i->language_status == 'Basic')?'selected':''}}  value="Basic">Basic</option>
                                                                            </select>
                                                                        </td>
                                                                        <td>
                                                            ...
                                                            @else
                                                                <tr>
                                                                    <td>
                                                                        <select class="form-control languageSelect" name="language_name[]"></select>
                                                                    </td>
                                                                    <td>
                                                                        <select class="form-control" name="language_status[]">
                                                                            <option value="Very Good">Very Good</option>
                                                                            <option value="Good">Good</option>
                                                                            <option value="Only For Speaking">Only For Speaking</option>
                                            ...
                                            <div class="row">
                                                @include('vendor.voyager.partials.form-field', ['formField'=>'include', 'fields'=>['expertise'], 'width'=>'4'])
                                                @include('vendor.voyager.partials.form-field', ['formField'=>'include', 'fields'=>['skills'], 'width'=>'4'])
                                                @include('vendor.voyager.partials.form-field', ['formField'=>'include', 'fields'=>['extra_curricular'], 'width'=>'4'])
                                                @include('vendor.voyager.partials.form-field', ['formField'=>'include', 'fields'=>['interest'], 'width'=>'4'])
                                                @include('vendor.voyager.partials.form-field', ['formField'=>'include', 'fields'=>['attribute'], 'width'=>'4'])
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="table-responsive">
                                                        <table id="expertiseTable" class="table table-bordered align-middle">
                                                            <thead class="table-dark">
                                                            <tr>
                                                                <th class="th-width">Expertise</th>
                                                                <th>Actions</th>
                                                            </tr>
                                                            </thead>
                                                            <tbody>
                                                            @if(count($expertiseList)> 0)
                                                                @foreach($expertiseList as $i)
                                                                    <tr>
                                                                        <td>
                                                                            <input type="text" class="form-control" name="expertise_name[]" value="{{$i->expertise_name}}"></input>
                                                                        </td>
                                                                        <td>
                                                                            <button type="button" class="btn btn-sm btn-success addBtn">Add</button>
                                                                            <button type="button" class="btn btn-sm btn-danger removeBtn">Remove</button>
                                                            ...
                                                            @else
                                                                <tr>
                                                                    <td>
                                                                        <input type="text" class="form-control" name="expertise_name[]"></input>
                                                                    </td>
                                                                    <td>
                                                                        <button type="button" class="btn btn-sm btn-success addBtn">Add</button>
                                                                        <button type="button" class="btn btn-sm btn-danger removeBtn">Remove</button>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="table-responsive">
                                                        <table id="skillTable" class="table table-bordered align-middle">
                                                            <thead class="table-dark">
                                                            <tr>
                                                                <th class="th-width">Skills</th>
                                                                <th>Actions</th>
                                                            </tr>
                                                            </thead>
                                                            <tbody>
                                                            @if(count($skillList)> 0)
                                                                @foreach($skillList as $i)
                                                                    <tr>
                                                                        <td>
                                                                            <input type="text" class="form-control" name="skill_name[]" value="{{$i->skill_name}}"></input>
                                                                        </td>
                                                                        <td>
                                                                            <button type="button" class="btn btn-sm btn-success addBtn">Add</button>
                                                                            <button type="button" class="btn btn-sm btn-danger removeBtn">Remove</button>
                                                            ...
                                                            @else
                                                                <tr>
                                                                    <td>
                                                                        <input type="text" class="form-control" name="skill_name[]"></input>
                                                                    </td>
                                                                    <td>
                                                                        <button type="button" class="btn btn-sm btn-success addBtn">Add</button>
                                                                        <button type="button" class="btn btn-sm btn-danger removeBtn">Remove</button>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="table-responsive">
                                                        <table id="curricularTable" class="table table-bordered align-middle">
                                                            <thead class="table-dark">
                                                            <tr>
                                                                <th class="th-width">Extra Curricular</th>
                                                                <th>Actions</th>
                                                            </tr>
                                                            </thead>
                                                            <tbody>
                                                            @if(count($curricularList)> 0)
                                                                @foreach($curricularList as $i)
                                                                    <tr>
                                                                        <td>
                                                                            <input type="text" class="form-control" name="curricular_name[]" value="{{$i->curricular_name}}"></input>
                                                                        </td>
                                                                        <td>
                                                                            <button type="button" class="btn btn-sm btn-success addBtn">Add</button>
                                                                            <button type="button" class="btn btn-sm btn-danger removeBtn">Remove</button>
                                                            ...
                                                            @else
                                                                <tr>
                                                                    <td>
                                                                        <input type="text" class="form-control" name="curricular_name[]"></input>
                                                                    </td>
                                                                    <td>
                                                                        <button type="button" class="btn btn-sm btn-success addBtn">Add</button>
                                                                        <button type="button" class="btn btn-sm btn-danger removeBtn">Remove</button>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="table-responsive">
                                                        <table id="interestTable" class="table table-bordered align-middle">
                                                            <thead class="table-dark">
                                                            <tr>
                                                                <th class="th-width">Interest</th>
                                                                <th>Actions</th>
                                                            </tr>
                                                            </thead>
                                                            <tbody>
                                                            @if(count($interestList)> 0)
                                                                @foreach($interestList as $i)
                                                                    <tr>
                                                                        <td>
                                                                            <input type="text" class="form-control" name="interest_name[]" value="{{$i->interest_name}}"></input>
                                                                        </td>
                                                                        <td>
                                                                            <button type="button" class="btn btn-sm btn-success addBtn">Add</button>
                                                                            <button type="button" class="btn btn-sm btn-danger removeBtn">Remove</button>
                                                            ...
                                                            @else
                                                                <tr>
                                                                    <td>
                                                                        <input type="text" class="form-control" name="interest_name[]"></input>
                                                                    </td>
                                                                    <td>
                                                                        <button type="button" class="btn btn-sm btn-success addBtn">Add</button>
                                                                        <button type="button" class="btn btn-sm btn-danger removeBtn">Remove</button>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="table-responsive">
                                                        <table id="attributeTable" class="table table-bordered align-middle">
                                                            <thead class="table-dark">
                                                            <tr>
                                                                <th class="th-width">Attribute</th>
                                                                <th>Actions</th>
                                                            </tr>
                                                            </thead>
                                                            <tbody>
                                                            @if(count($attributeList)> 0)
                                                                @foreach($attributeList as $i)
                                                                    <tr>
                                                                        <td>
                                                                            <input type="text" class="form-control" name="attribute_name[]" value="{{$i->attribute_name}}"></input>
                                                                        </td>
                                                                        <td>
                                                                            <button type="button" class="btn btn-sm btn-success addBtn">Add</button>
                                                                            <button type="button" class="btn btn-sm btn-danger removeBtn">Remove</button>
                                                            ...
                                                            @else
                                                                <tr>
                                                                    <td>
                                                                        <input type="text" class="form-control" name="attribute_name[]"></input>
                                                                    </td>
                                                                    <td>
                                                                        <button type="button" class="btn btn-sm btn-success addBtn">Add</button>
                                                                        <button type="button" class="btn btn-sm btn-danger removeBtn">Remove</button>
                                                ...
                                                @if($expriences)
                                                    @foreach($expriences as $i)
                                                        <div class="card mb-3 position-relative">
                                                            ...
                                                            <button  onclick="removeCard(this)" type="button" class="btn btn-sm btn-danger position-absolute" aria-label="Remove" style="top: 0px; right: 5px; position: absolute;"><i class="voyager-trash"></i></button></div>
                                                @endforeach
                                            @endif
                                                ...
                                                @if($educations)
                                                    @foreach($educations as $i)
                                                        <div class="card mb-3 position-relative">
                                                            ...
                                                            <button onclick="removeCard(this)" type="button" class="btn btn-sm btn-danger position-absolute" aria-label="Remove" style="top: 0px; right: 5px; position: absolute;" disabled=""><i class="voyager-trash"></i></button></div>
                                                @endforeach
                                            @endif
                                            <!--End show to saved data -->
                                                ...
                                                @if($trainings)
                                                    @foreach($trainings as $i)
                                                        <div class="card mb-3 position-relative">
                                                            ...
                                                            <button onclick="removeCard(this)" type="button" class="btn btn-sm btn-danger position-absolute" aria-label="Remove" disabled="" style="top: 0px; right: 5px; position: absolute;"><i class="voyager-trash"></i></button></div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                @include('vendor.voyager.partials.form-field', ['formField'=>'include', 'fields'=>['marital_status'], 'width'=>'4'])
                                            </div>
                                            <div class="row">
...
@section('javascript')
    ...
    <script>
        ...
        function validateCurrentStep() {
            ...
            var emailInput = currentStepElement.querySelector('input[type="email"]');
            if(emailInput !== null){
            ...
            var educationPassingYear = currentStepElement.querySelectorAll('input[name="education_passing_year[]"]');
            var isPassingYearValid = 0;
            if(educationPassingYear.length > 0){
                educationPassingYear.forEach(field => {
                    var passingYear = field.value;
                    if (parseInt(passingYear) <1900) {
                        isPassingYearValid++;
                    }
                });

                if(isPassingYearValid > 0){
                    toastr.error('Year Of passing must be greater than 1900 and less than this year.');
                    isValid =  false;
                }
    ...
    <script>
        $(document).ready(function() {
            ...
            function populateLanguages(select) {
                ...
                select.append(`<option value="">Select One</option>`); // Add placeholder
                languages.forEach(lang => {
                    select.append(`<option value="${lang}">${lang}</option>`);
                });
            }
            populateLanguages($("#languageTable tbody tr:first .languageSelect"));
            $(document).on("click", "#languageTable .addBtn", function() {
                let newRow = `
                      <tr>
                        <td><select class="form-control languageSelect" name="language_name[]"></select></td>
                        <td>
                          <select class="form-control" name="language_status[]">
                            <option value="Very Good">Very Good</option>
                            <option value="Good">Good</option>
                    ...
                    `;
                let $newRow = $(newRow);
                populateLanguages($newRow.find(".languageSelect"));
                $(this).closest("tr").after($newRow);
            });
            $(document).on("click", "#languageTable .removeBtn", function() {
                if ($("#languageTable tbody tr").length > 1) {
            ...
            //Area of expertise
            $(document).on("click", "#expertiseTable .addBtn", function() {
                let newRow = `
                      <tr>
                        <td><input type="text" class="form-control" name="expertise_name[]"></td>
                        <td>
                          <button type="button" class="btn btn-sm btn-success addBtn">Add</button>
                          <button type="button" class="btn btn-sm btn-danger removeBtn">Remove</button>
                        </td>
            ...
            $(document).on("click", "#expertiseTable .removeBtn", function() {
            ...
            //skill list
            $(document).on("click", "#skillTable .addBtn", function() {
                let newRow = `
                      <tr>
                        <td><input type="text" class="form-control" name="skill_name[]"></td>
                        <td>
                          <button type="button" class="btn btn-sm btn-success addBtn">Add</button>
                          <button type="button" class="btn btn-sm btn-danger removeBtn">Remove</button>
                        </td>
            ...
            $(document).on("click", "#skillTable .removeBtn", function() {
                if ($("#skillTable tbody tr").length > 1) {
                    $(this).closest("tr").remove();
                } else {
                    toastr.error('At least one row is required!');
                }
            ...
            //curricularTable list
            $(document).on("click", "#curricularTable .addBtn", function() {
                let newRow = `
                      <tr>
                        <td><input type="text" class="form-control" name="curricular_name[]"></td>
                        <td>
                          <button type="button" class="btn btn-sm btn-success addBtn">Add</button>
                          <button type="button" class="btn btn-sm btn-danger removeBtn">Remove</button>
                        </td>
            ...
            $(document).on("click", "#curricularTable .removeBtn", function() {
                if ($("#curricularTable tbody tr").length > 1) {
                    $(this).closest("tr").remove();
                } else {
                    toastr.error('At least one row is required!');
                }
            ...
            //interestTable list
            $(document).on("click", "#interestTable .addBtn", function() {
                let newRow = `
                      <tr>
                        <td><input type="text" class="form-control" name="interest_name[]"></td>
                        <td>
                          <button type="button" class="btn btn-sm btn-success addBtn">Add</button>
                          <button type="button" class="btn btn-sm btn-danger removeBtn">Remove</button>
                        </td>
            ...
            $(document).on("click", "#interestTable .removeBtn", function() {
                if ($("#interestTable tbody tr").length > 1) {
                    $(this).closest("tr").remove();
                } else {
                    toastr.error('At least one row is required!');
                }
            ...
            //attributeTable list
            $(document).on("click", "#attributeTable .addBtn", function() {
                let newRow = `
                      <tr>
            ...
            $(document).on("click", "#attributeTable .removeBtn", function() {
                if ($("#attributeTable tbody tr").length > 1) {
                    $(this).closest("tr").remove();
                } else {
                    toastr.error('At least one row is required!');
                }
