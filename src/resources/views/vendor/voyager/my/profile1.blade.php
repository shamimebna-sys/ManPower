...
@section('content')
    <div class="page-content container-fluid">
        ...
        <form class="form-edit-add" role="form"  id="multiStepForm"
              action=""
            ...
            <div class="row">
                <div class="col-md-12 step active">
                    <div class="panel panel-bordered panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                @include('vendor.voyager.partials.form-field', ['formField'=>'include', 'fields'=>['gender'], 'width'=>'3'])
                                @include('vendor.voyager.partials.form-field', ['formField'=>'include', 'fields'=>['blood_group'], 'width'=>'3'])
                                @include('vendor.voyager.partials.form-field', ['formField'=>'include', 'fields'=>['nationality'], 'width'=>'3'])
