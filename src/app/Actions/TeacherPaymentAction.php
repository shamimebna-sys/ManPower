...
class TeacherPaymentAction extends AbstractAction
{
    ...
    {
//        return $this->dataType->slug == 'teachers1';
    }

    public function getDefaultRoute()
    {
//        return route('admin.purchase.edit', array("id"=>$this->data->{$this->data->getKeyName()}));
        return route('voyager.payments.create').'?teacher_id='.$this->data->{$this->data->getKeyName()};
