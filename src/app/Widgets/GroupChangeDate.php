...
class GroupChangeDate extends BaseDimmer
{

    public function run()
    {
        $table = [
            'table_title' => 'GROUP CHANGE DATE',
            'table_th' => ['GROUP NAME', 'DATE'],
            'table_data' => [
    ...
    public function shouldBeDisplayed()
    {
        /*
           ...
           108	 	Agency
       */
        if( in_array(\auth()->user()->role_id, [1, 2, 100, 102, 103, 104, 105, 106, 107, 108])){
            return true;
        }else{
            return false;
        }
