...
class VoyagerAgencierController extends VoyagerBaseController
{
    private $role_id = 108;
    ...
    public function store(Request $request)
    {
        ...
        $request->merge(['code' => CommonClass::generateCode('AA')]);
        $request->merge(['email' => strtolower($request->get('email'))]);
        $validator = Validator::make($request->all(), [
            'code' => 'required|unique:agenciers,code',
//            'mobile' => 'required|unique:agenciers,mobile',
    ...
    public function update(Request $request, $id)
    {
        ...
        if(!empty($request->password)){
            $userEntity = User::where('agencier_id', $data->id)->first();
